...
export default function SectionTwo() {
    ...
    // Tracks the vertical scroll progress relative to the container element
    const { scrollYProgress } = useScroll({
        target: containerRef,
        offset: ["start start", "end end"]
    })

    // Maps the vertical scroll progress (0 to 1) to a horizontal pixel translation
    // This creates the horizontal scrolling effect as the user scrolls down
    ...
    // Applies a physics-based spring animation to make the horizontal scroll smooth and fluid
